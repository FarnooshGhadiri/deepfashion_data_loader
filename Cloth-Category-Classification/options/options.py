...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--dir', default='/home/farnoosh/Projects/DeepFashion/Category and Attribute Prediction Benchmark', help='path to the data directory containing Img and annotation')
        ...
        self.parser.add_argument('--model', default='VGG16', help='model type. [Alexnet | LightenB | VGG16 | Resnet18 | ...]')
        self.parser.add_argument('--load_size', type=int, default=244, help='scale image to the size prepared for croping')
        self.parser.add_argument('--input_size', type=int, default=224, help='then crop image to the size as network input')
        self.parser.add_argument('--ratio', type=str, default='[0.9, 0.05, 0.05]', help='ratio of whole dataset for Train, Validate, Test resperctively')
        ...
        self.parser.add_argument('--sum_epoch', type=int, default=5, help='sum epoches for training')
        ...
        self.parser.add_argument('--display_validate_freq', type=int, default=11, help='test validate dateset every $validate_freq batches iteration')
